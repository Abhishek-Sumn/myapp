          ...
          >
            ...
            <span class="">
              {isLoggedIn ? (
                ...
                <button onClick={() => setisLoggedIn(1)}>Sign In</button>
              )}
            </span>
          </Link>
        </li>

        <li className="sm:mr-7 md:mr-22 lg:mr-30 flex gap-1 relative items-center pl-8 font-medium text-base group hover:text-orange-500">
          <Link to="/cart">
